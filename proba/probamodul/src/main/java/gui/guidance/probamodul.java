 ...
 * <tt>config:/modules/probamodul</tt>. If you don't need this, simply remove
 * the reference to this class in the module descriptor xml. See
 * https://documentation.magnolia-cms.com/display/DOCS/Module+configuration for
 * information about module configuration.
 */
public class probamodul {
